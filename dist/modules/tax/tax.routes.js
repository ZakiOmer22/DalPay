...
router.post('/assessments/generate', auth_1.authenticate, (0, auth_1.authorize)('admin', 'super_admin'), taxController.generateAssessments);
...
router.get('/disputes/all', auth_1.authenticate, (0, auth_1.authorize)('admin', 'super_admin'), taxController.getAllDisputes);
router.patch('/disputes/:disputeId', auth_1.authenticate, (0, auth_1.authorize)('admin', 'super_admin'), taxController.resolveDispute);
router.get('/ledger', auth_1.authenticate, (0, auth_1.authorize)('admin', 'auditor'), async (req, res, next) => {
    try {
